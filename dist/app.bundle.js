...
/******/ 	deferredModules.push(["./src/app.ts","common_lib"]);
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.js"); // globalへの展開
    ...
    methods: {
        ...
        getInitialData: function () {
            ...
            fetch('../init-data.json')
                ...
                .then(function (json) {
                _this.items = json.todo;
            })
                .catch(function (err) { return console.log(err); }); // エラー発生時はログに記録する
        },
    },
});
